...
class ByteLevelDecoder extends BaseDecoder
{
    ...
    /**
     * @param array<string, AddedToken> $addedTokens     tokens added to the model
     * @param null|string               $endOfWordSuffix End of word suffix from the model (e.g., BPE models).
     */
    public function __construct(protected array $addedTokens = [], protected ?string $endOfWordSuffix = null) {}
    ...
    public function decode(array $tokens): string
    {
        ...
        if (null !== $this->endOfWordSuffix) {
            $decoded = str_replace($this->endOfWordSuffix, ' ', $decoded);
        }
     ...
     */
    protected function convertTokensToString(array $tokens): string
    {
        $text = implode('', $tokens);
    ...
    /**
     * @param string[] $tokens array of tokens to be processed
     *
    ...
    protected function processTokens(array $tokens): array
    {
        ...
        foreach ($tokens as $token) {
            if (isset($this->addedTokens[$token])) {
