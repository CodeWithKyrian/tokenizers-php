...
use Codewithkyrian\Tokenizers\Tests\Datasets\Models\GemmaDataset;
use Codewithkyrian\Tokenizers\Tokenizer;

dataset('gemma-tokenization', modelTokenizationDataset(GemmaDataset::class));
