...
use Codewithkyrian\Tokenizers\Tests\Datasets\Models\RobertaDataset;
use Codewithkyrian\Tokenizers\Tokenizer;

dataset('roberta-tokenization', modelTokenizationDataset(RobertaDataset::class));
